        ...
        <div className={styles["recent-container"]}>
            {races.map(race =>(
                <div className={styles["recent-item"]} key={race.race_id}>
                    ...
                    <div className="">
                        {race.rating>0 ? <Rating readOnly value={race.rating} size="small" sx={{color:'var(--color-text-secondary)'}} precision={0.5} emptyIcon={<StarIcon style={{opacity:1, color:'var(--color-text-secondary)',marginTop:'1px',marginLeft:'0.8px',}} size={16} strokeWidth={1}/>} />: null}
